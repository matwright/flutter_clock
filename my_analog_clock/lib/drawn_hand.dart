...
class _HandPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final circlePosition =
        center + Offset(math.cos(angle), math.sin(angle)) * (length + 23.5);
    ...
    para.layout(ParagraphConstraints(width: 60));
    canvas.drawCircle(circlePosition, 20, linePaint);
    canvas.drawParagraph(para, circlePosition);
    canvas.drawCircle(circlePosition, 5, Paint());
